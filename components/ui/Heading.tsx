...
export default function Heading({ 
  ...
  const levelClasses = {
    1: 'text-4xl font-bold text-gray-900 mb-2',
    2: 'text-3xl font-bold text-gray-900 mb-2',
    3: 'text-2xl font-semibold text-gray-900 mb-2',
    4: 'text-xl font-semibold text-gray-900 mb-2',
  };
