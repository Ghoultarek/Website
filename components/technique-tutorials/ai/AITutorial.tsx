...
export default function AITutorial() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">AI Fundamentals: Neural Networks & Backpropagation</h1>
      ...
      <section id="intro" className="mb-12 scroll-mt-8">
        <div className="bg-white dark:bg-[#171717] rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Introduction to Neural Networks</h2>
          ...
          <div className="prose max-w-none mb-6">
            <div className="bg-gray-50 dark:bg-[#0D0D0D] border border-gray-300 dark:border-gray-700 rounded-lg p-5 mb-6">
              ...
              <p className="text-gray-800 dark:text-white leading-relaxed italic">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
              <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">Key Components:</h3>
            ...
            <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
              <h3 className="font-semibold text-green-900 dark:text-green-200 mb-2">How Neural Networks Learn:</h3>
              <ol className="list-decimal list-inside text-green-800 dark:text-green-200 space-y-1">
      ...
      <section id="backprop" className="mb-12 scroll-mt-8">
        <div className="bg-white dark:bg-[#171717] rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Understanding Backpropagation</h2>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">The Chain Rule</h3>
            ...
            <div className="bg-gray-50 dark:bg-[#0D0D0D] border border-gray-200 dark:border-gray-700 rounded-lg p-6 flex justify-center">
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Step-by-Step Process</h3>
            <ol className="list-decimal list-inside text-gray-700 dark:text-white space-y-2">
