...
export default function DecisionTrees() {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 mb-6">
      <h2 className="text-2xl font-semibold text-gray-900 mb-4">Decision Trees</h2>
      ...
      <div className="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-6">
        <h3 className="font-semibold text-gray-900 mb-4">Example Decision Tree</h3>
        <div className="flex justify-center">
          <svg width="600" height="420" className="w-full max-w-2xl">
            ...
            {/* Labels */}
            <text x="300" y="15" textAnchor="middle" className="text-xs fill-gray-600">Root Node</text>
            <text x="150" y="115" textAnchor="middle" className="text-xs fill-gray-600">Internal Node</text>
            <text x="450" y="115" textAnchor="middle" className="text-xs fill-gray-600">Internal Node</text>
            <text x="100" y="295" textAnchor="middle" className="text-xs fill-gray-600">Leaf</text>
            <text x="200" y="295" textAnchor="middle" className="text-xs fill-gray-600">Leaf</text>
            <text x="400" y="295" textAnchor="middle" className="text-xs fill-gray-600">Leaf</text>
            <text x="500" y="295" textAnchor="middle" className="text-xs fill-gray-600">Leaf</text>
          </svg>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-semibold text-blue-900 mb-2">Root Node</h4>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h4 className="font-semibold text-green-900 mb-2">Internal Nodes</h4>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <h4 className="font-semibold text-purple-900 mb-2">Leaf Nodes</h4>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h4 className="font-semibold text-yellow-900 mb-2">Splitting Criteria</h4>
      ...
      <div className="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
        <h3 className="font-semibold text-gray-900 mb-3">How Trees Make Predictions</h3>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h4 className="font-semibold text-blue-900 mb-2">Why Ensemble Methods?</h4>
        <p className="text-sm text-blue-800">
